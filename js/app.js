...
window.addEventListener('load', function () {
  ...
  var main_navigation = document.querySelector('.menu-bar');
  var primaryMenuToggle = document.querySelector('#primary-menu-toggle');
  var closeMenuToggle = document.querySelector('#close-menu-toggle');
